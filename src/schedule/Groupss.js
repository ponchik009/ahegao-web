...
function Groupss() {
    ...
    return(
        <div style={{backgroundImage: "url(https://www.k50messut.fi/wp-content/uploads/2018/02/Muumimuseo_RGB_Vaaka_Nega_FIN.png)", backgroundSize: 'cover', width: '100%', height: '90vh'}}>
    <Box sx={{ width: '100%'}} >
      <BottomNavigation
        showLabels
        value={value}
