...
function App() {
  ...
  return (
    <div>
      ...
      <Typography mt={2} ml={62} variant="h1" gutterBottom component="div">
        Расписание
      </Typography>
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          <BottomNavigationAction
            style={{ marginLeft: "50px", marginTop: "230px" }}
            label="Расписание по группам"
            icon={<GroupIcon sx={{ fontSize: 100 }} />}
          />
          <BottomNavigationAction
            style={{ marginLeft: "100px", marginTop: "230px" }}
            label="Расписание по преподавателям"
            icon={<SchoolIcon sx={{ fontSize: 100 }} />}
          />
          <BottomNavigationAction
            style={{ marginLeft: "150px", marginTop: "230px" }}
            label="Расписание по аудиториям"
            icon={<MeetingRoomIcon sx={{ fontSize: 100 }} />}
          />
        </BottomNavigation>
      </Box>
      <div className="App">
